...
// 5.menghitung jumlah query
$hitung = mysqli_num_rows($result);

  if($hitung > 0){
      // proses login

      // 1.mengambil seluryh data login
...
<div class="login-box">
  <div class="login-logo">
    <a href="index2.html"><b>GURUN</b></a>
  </div>
  <!-- /.login-logo -->
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Sign in to start your session ngab</p>
