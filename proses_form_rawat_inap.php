...
$qry = "UPDATE rawat_inap SET norawatinap='$norawatinap', norekmed='$norekmed', tgl_masuk='$tgl_masuk', tgl_keluar='$tgl_keluar', progres_tindakan='$progres_tindakan' WHERE id='$id'";
